...
class ASTGenSuite(unittest.TestCase):
    ...
    def test_not_left_value_with_var(self):
        ...
        """
        expect = "Not Left Value: BinaryOp(=,BinaryOp(+,Id(a),IntLiteral(1)),IntLiteral(10))"
    ...
    def test_not_left_value_with_exp_left_not_storage_function(self):
        ...
        """
        expect = "Not Left Value: BinaryOp(=,BinaryOp(+,IntLiteral(3),IntLiteral(1)),CallExpr(Id(foo),[]))"
    ...
    def test_not_left_value_with_function(self):
        ...
        """
        expect = "Not Left Value: BinaryOp(=,CallExpr(Id(foo),[]),IntLiteral(10))"
    ...
    def test_not_left_value_with_arraycell(self):
        ...
        """
        expect = "Not Left Value: BinaryOp(=,BinaryOp(+,ArrayCell(Id(b),IntLiteral(1)),IntLiteral(1)),BinaryOp(+,ArrayCell(Id(c),IntLiteral(7)),IntLiteral(10)))"
    ...
    def test_correct_many_include_decl_return_callExpr_Binary(self):
        input = """
        int i ;
        int f() {
            return 200;
